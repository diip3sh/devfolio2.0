  ...
  return (
    <section className="bg-primary">
      <div className="px-8 2xl:max-w-7xl mx-auto py-32">
        ...
        <ul
          className="mx-auto grid grid-cols-1 sm:grid-cols-2 text-secondary md:grid-cols-3 lg:grid-cols-4 items-start gap-6 mt-32"
          role="list"
        >
            ...
            >
              <a href={project.url}>
                <div className="h-full flex flex-col justify-between">
                  <div>
                    <p className="group-hover:text-secondary/70 text-secondary text-9xl font-black lg:rotate-90 xl:-translate-x-28 lg:-translate-x-16 lg:mb-8 xl:mb-0">
                      0{index + 1}.
                    </p>
